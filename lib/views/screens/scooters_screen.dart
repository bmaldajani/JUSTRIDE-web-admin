...
class _ScooterScreenState extends State<ScooterScreen> {
  ...
  void initState() {
    ...
    _dataSource = DataSource(
      onDetailButtonPressed: (data) => GoRouter.of(context).go('${RouteUri.scooterDetail}?id=${data['id']}'),
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          onPressed: () => GoRouter.of(context).go(RouteUri.scooterDetail),
                                          child: Row(
                                            mainAxisSize: MainAxisSize.min,
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
...
class DataSource extends DataTableSource {
  ...
  final _data = List.generate(200, (index) {
    return {
      'id': index + 1,
      'location': "M4",
      'status': ("booked", "unavailable", "availble"),
      'battery level': 80,
    };
  });
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(index: index, cells: [
      ...
      DataCell(Text(data['battery level'].toString())),
      DataCell(Builder(
        builder: (context) {
          return Row(
            mainAxisSize: MainAxisSize.min,
